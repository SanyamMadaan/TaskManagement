...
const page = () => {
  return (
    <main className="bg-black h-screen flex flex-col items-center justify-center">
      <div>
        <h1 className="mb-3 text-white text-4xl font-bold">SIGN IN</h1>
      </div>

      <form className="md:border-2 border-white md:p-5 flex items-center flex-col justify-center">
        <Input
          className="border-2 border-white text-slate-400 p-5 text-xl lg:text-slate-100 w-full md:w-4/5 h-14  my-5"
          type="email"
